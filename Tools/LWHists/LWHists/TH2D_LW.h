...
////////////////////////////////////////////////////////////////
//                                                            //
//  Header file for class TH2D_LW                             //
//                                                            //
//  Description: LightWeight version of TH2D.                 //
//                                                            //
...
private:
  ...
  TH2D_LW( const char* name, const char* title,
	   unsigned nbinsx, const double& xmin, const double& xmax,
  ...
  TH2D_LW & operator= ( const TH2D_LW & );
  void * m_flexHisto;
  TH2D * m_rootHisto;
