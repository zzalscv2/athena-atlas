...
dcubeRef="/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/TrfTestsART/dcube/q443/v0/hist_physlite_2305.root"
dcubeXML="/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/TrfTestsART/dcube/q443/v0/dcube_config_hist_physlite_2305.xml"
echo ${dcubeRef}
echo ${dcubeXML}
