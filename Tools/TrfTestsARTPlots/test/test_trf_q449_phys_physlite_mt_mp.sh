...
dcubeRef="/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/TrfTestsART/dcube/q449/v3/hist_physlite_2311.root"
dcubeXML="/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/TrfTestsART/dcube/q449/v3/dcube_config_hist_physlite_2311.xml"
echo ${dcubeRef}
echo ${dcubeXML}
