...
dcubeRef="/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/TrfTestsART/dcube/q449/v2/hist_physlite_2307.root"
dcubeXML="/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/TrfTestsART/dcube/q449/v2/dcube_config_hist_physlite_2307.xml"
echo ${dcubeRef}
echo ${dcubeXML}
