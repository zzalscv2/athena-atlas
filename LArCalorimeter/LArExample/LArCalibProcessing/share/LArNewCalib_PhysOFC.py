...
if __name__=='__main__':
   ...
   parser.add_argument('-d','--insqlitefile', dest='insqlitefile', default="", help='Input sqlite file with PhysWave and PhysAutocorr`', type=str)
   ...
   parser.add_argument('-l','--outprefix', dest='outprefix', default="LArPhysOFC", help='Output root file name', type=str)
   parser.add_argument('-n','--outsqlite', dest='outsql', default="mysql_physofc.db", help='Output sqlite file, in pool output dir.', type=str)
