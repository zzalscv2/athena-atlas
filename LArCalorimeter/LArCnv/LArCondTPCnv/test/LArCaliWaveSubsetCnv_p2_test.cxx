...
*/
/**
 * @file LArCondTPCnv/test/LArCaliWaveSubsetCnv_p2_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jan, 2020
 * @brief Tests for LArCaliWaveSubsetCnv_p2.
 */
...
void testit (const TransType& trans1)
{
  ...
  LArCaliWaveSubsetCnv_p2 cnv;
  LArCaliWaveSubset_p2 pers;
...
{
  std::cout << "LArCondTPCnv/LArCaliWaveSubsetCnv_p2_test\n";
  test1();
  return 0;
}
