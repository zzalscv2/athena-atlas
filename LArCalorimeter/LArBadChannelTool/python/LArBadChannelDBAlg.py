...
if __name__=="__main__":
    ...
    ConfigFlags.Input.RunNumber=args.runnumber if args.runnumber>0 else 300000
    ...
    ConfigFlags.IOVDb.DBConnection="sqlite://;schema="+args.output+";dbname=CONDBR2"
    ...
    cfg.merge(LArBadChannelDBAlgCfg(ConfigFlags, 
                                    args.inputfile,
                                    folder=args.folder,
                                    tag=args.tag,
