...
def TrigALFAROBMonitor(flags):
   ...
   for station in stations:
      ...
      if station.find("U") != -1:
         ...
         monToolTrackingElast_1LB.defineHistogram("elastic_" + station + ",y", type='TH2F', path='EXPERT', title=station + " 1LB elastic ;x;y",   xbins=260, xmin=-23., xmax=23., ybins=175, ymin=0.,ymax=35.,opt='kLBNHistoryDepth=1,kAlwaysCreate')
