...
def InDetGlobalLRTMonAlgCfg(helper, alg, **kwargs):
    ...
    varName = 'm_eta_perigee,m_phi_perigee,m_noTRTHits;Trk_noTRText_eta_phi_ratio'
    ...
    varName = 'm_eta_perigee,m_phi_perigee,m_InnermostPixelLayerHit;Trk_noIBLhit_eta_phi_ratio'
    ...
    varName = 'm_eta_perigee,m_phi_perigee,m_sctHits;Trk_nSCThits_eta_phi'
    title = 'Number of SCT hits per track, eta-phi profile;#eta;#phi'
    lrtGroup.defineHistogram(varName, type='TProfile2D', path=pathhits, title=title, xbins=m_nBinsEta, xmin=-m_c_etaRange, xmax=m_c_etaRange, ybins=m_nBinsPhi, ymin=-M_PI, ymax=M_PI)

    varName = 'm_eta_perigee,m_phi_perigee,m_trtHits;Trk_nTRThits_eta_phi'
    title = 'Number of TRT hits per track, eta-phi profile;#eta;#phi'
    lrtGroup.defineHistogram(varName, type='TProfile2D', path=pathhits, title=title, xbins=m_nBinsEta, xmin=-m_c_etaRange, xmax=m_c_etaRange, ybins=m_nBinsPhi, ymin=-M_PI, ymax=M_PI)

    varName = 'm_lb,m_numberOfInnermostPixelLayerHits;trk_nIBLhits_LB'
    ...
    varName = 'm_lb,m_sctHits;trk_nSCThits_LB'
    title = 'Average number of SCT hits by LB;LB;Average number of hits in LB'
    lrtGroup.defineHistogram(varName, type='TProfile', path=pathtrack, title=title, xbins=m_c_range_LB, xmin=0, xmax=m_c_range_LB)

    varName = 'm_lb,m_trtHits;trk_nTRThits_LB'
    ...
    varName = 'm_eta_perigee,m_phi_perigee,m_numberOfTRTDeadStraws;Trk_nTRTdisabled_eta_phi'
    ...
    varName = 'm_lb,m_nNoIBL_LB;Trk_noIBLhits_LB'
    ...
    varName = 'm_lb,m_NoIBL_LB;Trk_noIBLhits_frac_LB'
    ...
    varName = 'm_lb,m_nNoTRText_LB;Trk_noTRText_LB'
    ...
    varName = 'm_lb,m_NoTRText_LB;Trk_noTRText_frac_LB'
