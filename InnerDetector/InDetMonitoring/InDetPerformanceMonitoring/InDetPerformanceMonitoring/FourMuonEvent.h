...
class FourMuonEvent : public EventAnalysis
{
 public:
  ...
  inline int                         GetVertexMuNeg1 () { return m_muon_vtx[0];} 
  inline int                         GetVertexMuNeg2 () { return m_muon_vtx[1];} 
  inline int                         GetVertexMuPos1 () { return m_muon_vtx[2];} 
  inline int                         GetVertexMuPos2 () { return m_muon_vtx[3];} 
