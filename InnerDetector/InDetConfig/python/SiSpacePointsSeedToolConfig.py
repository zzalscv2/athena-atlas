...
def SiSpacePointsSeedMakerCfg(flags, name="InDetSpSeedsMaker", **kwargs) :
    ...
    kwargs.setdefault("maxdImpact", flags.InDet.Tracking.ActiveConfig.maxPrimaryImpact)
    ...
    kwargs.setdefault("usePixel", flags.InDet.Tracking.ActiveConfig.usePixel
                      and flags.InDet.Tracking.ActiveConfig.extension != "R3LargeD0")
    kwargs.setdefault("SpacePointsPixelName", 'PixelSpacePoints')
    kwargs.setdefault("useSCT", flags.InDet.Tracking.ActiveConfig.useSCT
                      and flags.InDet.Tracking.ActiveConfig.useSCTSeeding)
    kwargs.setdefault("SpacePointsSCTName", 'SCT_SpacePoints')
    kwargs.setdefault("useOverlapSpCollection", flags.InDet.Tracking.ActiveConfig.useSCT \
                      and flags.InDet.Tracking.ActiveConfig.useSCTSeeding)
    ...
    if not flags.Reco.EnableHI \
       and (flags.InDet.Tracking.ActiveConfig.extension=="" \
            or flags.InDet.Tracking.ActiveConfig.extension=="Forward" \
            or flags.InDet.Tracking.ActiveConfig.extension=="BLS"):
        kwargs.setdefault("maxdImpactPPS", flags.InDet.Tracking.ActiveConfig.maxdImpactPPSSeeds)
        kwargs.setdefault("maxdImpactSSS", flags.InDet.Tracking.ActiveConfig.maxdImpactSSSSeeds)
        kwargs.setdefault("maxSeedsForSpacePointStrips", flags.InDet.Tracking.ActiveConfig.maxSeedsPerSP_Strips)
        kwargs.setdefault("maxSeedsForSpacePointPixels", flags.InDet.Tracking.ActiveConfig.maxSeedsPerSP_Pixels)
        kwargs.setdefault("alwaysKeepConfirmedStripSeeds", flags.InDet.Tracking.ActiveConfig.keepAllConfirmedStripSeeds)
        kwargs.setdefault("alwaysKeepConfirmedPixelSeeds", flags.InDet.Tracking.ActiveConfig.keepAllConfirmedPixelSeeds)
    ...
    if flags.Beam.Type is not BeamType.Cosmics:
        kwargs.setdefault("maxRadius1", 0.75*flags.InDet.Tracking.ActiveConfig.radMax)
        kwargs.setdefault("maxRadius2", flags.InDet.Tracking.ActiveConfig.radMax)
        kwargs.setdefault("maxRadius3", flags.InDet.Tracking.ActiveConfig.radMax)
    ...
    InDetSiSpacePointsSeedMaker = SiSpacePointsSeedMaker (name = name+flags.InDet.Tracking.ActiveConfig.extension, **kwargs)
...
def ITkSiSpacePointsSeedMakerCfg(flags, name="ITkSpSeedsMaker", **kwargs) :
    ...
    kwargs.setdefault("maxdImpact", flags.ITk.Tracking.ActiveConfig.maxPrimaryImpactSeed)
    ...
    kwargs.setdefault("usePixel", flags.ITk.Tracking.ActiveConfig.useITkPixel
                      and flags.ITk.Tracking.ActiveConfig.useITkPixelSeeding)
    kwargs.setdefault("SpacePointsPixelName", 'ITkPixelSpacePoints')
    kwargs.setdefault("useStrip", flags.ITk.Tracking.ActiveConfig.useITkStrip
                      and flags.ITk.Tracking.ActiveConfig.useITkStripSeeding)
    kwargs.setdefault("SpacePointsStripName", 'ITkStripSpacePoints')
    kwargs.setdefault("useOverlapSpCollection", flags.ITk.Tracking.ActiveConfig.useITkStrip
                      and flags.ITk.Tracking.ActiveConfig.useITkStripSeeding )
    ...
    if flags.Beam.Type is not BeamType.Cosmics:
        kwargs.setdefault("maxRadius1", 0.75*flags.ITk.Tracking.ActiveConfig.radMax)
        kwargs.setdefault("maxRadius2", flags.ITk.Tracking.ActiveConfig.radMax)
        kwargs.setdefault("maxRadius3", flags.ITk.Tracking.ActiveConfig.radMax)
    ...
    if flags.ITk.Tracking.ActiveConfig.extension == "LargeD0":
        ...
        kwargs.setdefault("maxZPPP", flags.ITk.Tracking.ActiveConfig.maxZSpacePointsPPPSeeds)
        kwargs.setdefault("maxZSSS", flags.ITk.Tracking.ActiveConfig.maxZSpacePointsSSSSeeds)
    ...
    acc.setPrivateTools(CompFactory.ITk.SiSpacePointsSeedMaker(name = name+flags.ITk.Tracking.ActiveConfig.extension, **kwargs))
    return acc
