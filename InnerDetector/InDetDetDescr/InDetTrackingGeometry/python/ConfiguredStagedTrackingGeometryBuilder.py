...
# define the class
class ConfiguredStagedTrackingGeometryBuilder( InDet__StagedTrackingGeometryBuilder ):
    # constructor
    def __init__(self,name = 'InDetTrackingGeometryBuilder',
        ...
        if DetFlags.TRT_on() :
            ...
            # the layer providers
            TRT_LayerProvider = Trk__LayerProvider(name=namePrefix+'TRT_LayerProvider')
