...
InDet::StagedTrackingGeometryBuilderCond::trackingGeometry // Thread unsafe TrackingGeometry::indexStaticLayers method is used.
...
InDet::LayerSetupCond
InDet::StagedTrackingGeometryBuilderCond::estimateLayerSetup(
  ...
  double maxZ) const
{
  ...
  return InDet::LayerSetupCond(idName,
...
void
InDet::StagedTrackingGeometryBuilderCond::estimateLayerDimensions(
...
bool
InDet::StagedTrackingGeometryBuilderCond::setupFitsCache(
...
bool InDet::StagedTrackingGeometryBuilderCond::ringLayout(const std::vector<Trk::Layer*>& layers, std::vector<double>& rmins, std::vector<double>& rmaxs) const {
...
std::vector<Trk::Layer*> InDet::StagedTrackingGeometryBuilderCond::checkZoverlap(std::vector<Trk::Layer*>& lays) const 
{
...
Trk::Layer* InDet::StagedTrackingGeometryBuilderCond::mergeDiscLayers (std::vector<Trk::Layer*>& inputDiscs) const {
