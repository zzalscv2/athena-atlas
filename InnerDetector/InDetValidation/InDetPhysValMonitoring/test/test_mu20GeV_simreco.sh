#!/bin/bash
# art-description: art job for InDetPhysValMonitoring, Single mu 20GeV
# art-type: grid
...
dcuberef_sim=$artdata/InDetPhysValMonitoring/ReferenceHistograms/SiHitValid_mu_20GeV_simreco_${relname}.root
dcubecfg_pixel=$artdata/InDetPhysValMonitoring/dcube/config/run2_PixelRDOAnalysis.xml
dcuberef_pixel=$artdata/InDetPhysValMonitoring/ReferenceHistograms/PixelRDOAnalysis_mu_20GeV_simreco_${relname}.root
dcubecfg_sct=$artdata/InDetPhysValMonitoring/dcube/config/run2_SCTRDOAnalysis.xml
dcuberef_sct=$artdata/InDetPhysValMonitoring/ReferenceHistograms/SCT_RDOAnalysis_mu_20GeV_simreco_${relname}.root
...
dcuberef_rec=$artdata/InDetPhysValMonitoring/ReferenceHistograms/physval_mu_20GeV_simreco_${relname}.root
