...
dcuberef_pixel=$artdata/InDetPhysValMonitoring/ReferenceHistograms/PixelRDOAnalysis_mu_100GeV_simreco_${relname}.root
dcubecfg_sct=$artdata/InDetPhysValMonitoring/dcube/config/run2_SCTRDOAnalysis.xml
dcuberef_sct=$artdata/InDetPhysValMonitoring/ReferenceHistograms/SCT_RDOAnalysis_mu_100GeV_simreco_${relname}.root
...
dcuberef_rec=$artdata/InDetPhysValMonitoring/ReferenceHistograms/physval_mu_100GeV_simreco_${relname}.root
