...
void PixelRadiationDamageFluenceMapData::setLorentzMap_e(std::vector<PixelHistoConverter> lorentzMap_e) { m_lorentzMap_e = std::move(lorentzMap_e); }
void PixelRadiationDamageFluenceMapData::setLorentzMap_h(std::vector<PixelHistoConverter> lorentzMap_h) { m_lorentzMap_h = std::move(lorentzMap_h); }
void PixelRadiationDamageFluenceMapData::setDistanceMap_e(std::vector<PixelHistoConverter> distanceMap_e) { m_distanceMap_e = std::move(distanceMap_e); }
void PixelRadiationDamageFluenceMapData::setDistanceMap_h(std::vector<PixelHistoConverter> distanceMap_h) { m_distanceMap_h = std::move(distanceMap_h); }
void PixelRadiationDamageFluenceMapData::setRamoPotentialMap(std::vector<PixelHistoConverter> ramoPotentialMap) { m_ramoPotentialMap = std::move(ramoPotentialMap); }
...
void PixelRadiationDamageFluenceMapData::setFluenceLayer3D(std::vector<double> fluenceLayer) { m_fluenceLayer3D = std::move(fluenceLayer); }
double PixelRadiationDamageFluenceMapData::getFluenceLayer3D(int layer) const { return m_fluenceLayer3D.at(layer); }

void PixelRadiationDamageFluenceMapData::setRamoPotentialMap3D(std::vector<PixelHistoConverter> ramoPotentialMap3D) { m_ramoPotentialMap3D = std::move(ramoPotentialMap3D); }
void PixelRadiationDamageFluenceMapData::setEFieldMap3D(std::vector<PixelHistoConverter> eFieldMap3D) { m_eFieldMap3D = std::move(eFieldMap3D); }
void PixelRadiationDamageFluenceMapData::setXPositionMap3D_e(std::vector<PixelHistoConverter> xPositionMap3D_e) { m_xPositionMap3D_e = std::move(xPositionMap3D_e); }
void PixelRadiationDamageFluenceMapData::setXPositionMap3D_h(std::vector<PixelHistoConverter> xPositionMap3D_h) { m_xPositionMap3D_h = std::move(xPositionMap3D_h); }
void PixelRadiationDamageFluenceMapData::setYPositionMap3D_e(std::vector<PixelHistoConverter> yPositionMap3D_e) { m_yPositionMap3D_e = std::move(yPositionMap3D_e); }
void PixelRadiationDamageFluenceMapData::setYPositionMap3D_h(std::vector<PixelHistoConverter> yPositionMap3D_h) { m_yPositionMap3D_h = std::move(yPositionMap3D_h); }
void PixelRadiationDamageFluenceMapData::setTimeMap3D_e(std::vector<PixelHistoConverter> timeMap3D_e) { m_timeMap3D_e = std::move(timeMap3D_e); }
void PixelRadiationDamageFluenceMapData::setTimeMap3D_h(std::vector<PixelHistoConverter> timeMap3D_h) { m_timeMap3D_h = std::move(timeMap3D_h); }
void PixelRadiationDamageFluenceMapData::setAvgChargeMap3D_e(const PixelHistoConverter& avgChargeMap3D_e) { m_avgChargeMap3D_e = avgChargeMap3D_e; }
void PixelRadiationDamageFluenceMapData::setAvgChargeMap3D_h(const PixelHistoConverter& avgChargeMap3D_h) { m_avgChargeMap3D_h = avgChargeMap3D_h; }
