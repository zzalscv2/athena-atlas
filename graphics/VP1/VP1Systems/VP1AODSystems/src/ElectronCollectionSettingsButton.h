...
class ElectronCollectionSettingsButton : public VP1MaterialButtonBase {

  Q_OBJECT

public:
  
  ElectronCollectionSettingsButton(QWidget * parent = 0, int dim = 25);//dim<=0 => Won't change sizepolicy
