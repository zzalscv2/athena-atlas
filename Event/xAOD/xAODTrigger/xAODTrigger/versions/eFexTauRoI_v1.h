...
namespace xAOD {
   ...
   public:
      ...
      enum AlgoType {
         Heuristic = 0, ///< This object is generated by the heuristic algorithm
         BDT   = 1  ///< This object is generated by the BDT algorithm
      };
   ...
   private:
      ...
      /// Compute TOB eta. The computation changes for
      /// BDT and heuristic versions of the tau algorithm
