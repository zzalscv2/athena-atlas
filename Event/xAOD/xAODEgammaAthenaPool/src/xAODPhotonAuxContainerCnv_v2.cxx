...
void xAODPhotonAuxContainerCnv_v2::
persToTrans( const xAOD::PhotonAuxContainer_v2* oldObj,
...
transToPers( const xAOD::PhotonAuxContainer*,
   ...
   log << MSG::ERROR
       ...
       << endmsg;
   throw std::runtime_error( "Somebody called xAODPhotonAuxContainerCnv_v2::"
                             "transToPers" );
