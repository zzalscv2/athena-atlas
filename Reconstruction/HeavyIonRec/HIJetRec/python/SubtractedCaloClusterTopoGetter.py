...
def addSnapshot(corrName,contName):
    ...
    mlog = logging.getLogger('SubtractedCaloClusterTopoGetter:addSnapshot')
...
class SubtractedCaloClusterTopoGetter ( Configured )  :
    ...
    if jobproperties.CaloTopoClusterFlags.doTopoClusterLocalCalib() or jobproperties.CaloTopoClusterFlags.doCellWeightCalib():
        _outputKey = "SubtractedCaloCalTopoClusters" # the main (AOD) object key
        _output = { _outputType : ["SubtractedCaloCalTopoClusters","SubtractedCaloTopoCluster"],
                    "xAOD::CaloClusterAuxContainer" : ["SubtractedCaloTopoClusterAux.","SubtractedCaloCalTopoClustersAux."],
                    "CaloClusterCellLinkContainer" : ["SubtractedCaloCalTopoClusters_links","SubtractedCaloTopoCluster_links"]
                    }
    else:
        _outputKey = "SubtractedCaloTopoCluster" # the main (AOD) object key
        _output = { _outputType : "SubtractedCaloTopoCluster",
                    "xAOD::CaloClusterAuxContainer" : "SubtractedCaloTopoClusterAux.",
                    "CaloClusterCellLinkContainer" : "SubtractedCaloTopoCluster_links"
                    }

    def configure(self):
        mlog = logging.getLogger( 'SubtractedCaloClusterTopoGetter::configure :' )
        ...
        if jobproperties.CaloTopoClusterFlags.doCellWeightCalib():
            ...
            CellWeights = CaloClusterCellWeightCalib("CellWeights_Subtracted")
        ...
        if jobproperties.CaloTopoClusterFlags.doTopoClusterLocalCalib():
            ...
            # tools used by tools
            LCClassify   = CaloLCClassificationTool("LCClassify_Subtracted")
            ...
            LocalCalib = CaloClusterLocalCalib ("LocalCalib_Subtracted")
            ...
            OOCCalib   = CaloClusterLocalCalib ("OOCCalib_Subtracted")
            ...
            OOCPi0Calib   = CaloClusterLocalCalib ("OOCPi0Calib_Subtracted")
            ...
            DMCalib    = CaloClusterLocalCalib ("DMCalib_Subtracted")
        ...
        TopoMoments = CaloClusterMomentsMaker ("TopoMoments_Subtracted")
        ...
        try:
            ...
            log = logging.getLogger('SubtractedCaloClusterTopoGetter')
            log.info('Unable to import DigitizationFlags in SubtractedCaloClusterTopoGetter. Expected in AthenaP1')

        if doDigiTruthFlag:
          TopoMoments_Truth = CaloClusterMomentsMaker_DigiHSTruth ("TopoMoments_Truth_Subtracted")
        ...
        theCaloClusterSnapshot=CaloClusterSnapshot(OutputName="SubtractedCaloTopoCluster",SetCrossLinks=True)

            
        # maker tools
        TopoMaker = CaloTopoClusterMaker("TopoMaker_Subtracted")
        ...
        TopoSplitter = CaloTopoClusterSplitter("TopoSplitter_Subtracted")
        ...
        # cluster maker
        CaloTopoCluster = CaloClusterMaker ("CaloTopoCluster_Subtracted")
        if jobproperties.CaloTopoClusterFlags.doTopoClusterLocalCalib():
            CaloTopoCluster.ClustersOutputName="SubtractedCaloCalTopoClusters"
        else:
            CaloTopoCluster.ClustersOutputName="SubtractedCaloTopoCluster"
        ...
        if jobproperties.CaloTopoClusterFlags.doClusterVertexFraction():
            ...
            MyCaloClusterVertexFractionMaker = CaloClusterVertexFractionMaker(name            = "CaloClusterVertexFractionMaker_Subtracted",
        ...
        if jobproperties.CaloTopoClusterFlags.doCalibHitMoments() and rec.doTruth():
            ...
            TopoCalibMoments = CaloCalibClusterMomentsMaker2 ("TopoCalibMoments_Subtracted")
        ...
        #
        # pool/cool part
        # local calibration setup copied from CaloRec/python/CaloClusterTopoGetter.py
        if jobproperties.CaloTopoClusterFlags.doTopoClusterLocalCalib():
            from CaloRec import CaloClusterTopoCoolFolder  # noqa: F401
            if globalflags.DetDescrVersion().startswith("Rome"):
                CaloTopoCluster.LocalCalib_Subtracted.LCClassify_Subtracted.MaxProbability = 0.85
                CaloTopoCluster.LocalCalib_Subtracted.LCClassify_Subtracted.UseNormalizedEnergyDensity = False 
            else:   
                CaloTopoCluster.LocalCalib_Subtracted.LCClassify_Subtracted.MaxProbability = 0.50
                CaloTopoCluster.LocalCalib_Subtracted.LCClassify_Subtracted.UseNormalizedEnergyDensity = True
