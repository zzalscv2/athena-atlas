                                                      ...
                                                      MsgStream& msg ) const
{
    ...
    if (msg.level() <= MSG::DEBUG) msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p2::persToTrans(): PERS size = " << pers->m_entries.size() << endmsg;
    ...
    if (msg.level() <= MSG::DEBUG) msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p2::persToTrans() DONE" << endmsg;
}
                                                      ...
                                                      MsgStream& msg ) const
{
    if (msg.level() <= MSG::DEBUG) {
        ...
        msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p2::transToPers(): input size = " << trans->size() << endmsg;
    }
    ...
    if (msg.level() <= MSG::DEBUG) msg << MSG::DEBUG << "TrackParticleTruthCollectionCnv_p2::transToPers() DONE" << endmsg;
}
