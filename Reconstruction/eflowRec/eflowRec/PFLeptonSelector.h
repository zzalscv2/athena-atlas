...
class PFLeptonSelector : public AthReentrantAlgorithm
{
...
private:
  ...
  StatusCode selectElectrons(SG::WriteHandle<ConstDataVector<xAOD::ElectronContainer>>& selectedElectronsWriteHandle,
  ...
  /** select  muons to use */
  StatusCode selectMuons(SG::WriteHandle<ConstDataVector<xAOD::MuonContainer>>& selectedMuonsWriteHandle,
                         const SG::WriteHandle<ConstDataVector<CaloCellContainer>>& leptonCaloCellsWriteHandle) const;
  ...
  SG::ReadHandleKey<xAOD::MuonContainer> m_muonsReadHandleKey{ this,
                                                               "inputMuonsName",
                                                               "Muons",
                                                               "ReadHandle for the MuonContainer to be used as input" };
