...
Reco_tf.py --CA --athenaopts="--threads=1"  --preExec "${preExecString}" --postExec "${postExecString}" --conditionsTag="${conditionsTagString}" --geometryVersionString="${geometryVersionString}" --inputBSFile /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/RecJobTransformTests/data22_13p6TeV/data22_13p6TeV.00430536.physics_Main.daq.RAW/data22_13p6TeV.00430536.physics_Main.daq.RAW._lb1015._SFO-20._0001.data  --outputAODFile=myAOD.pool.root --outputESDFile=myESD.pool.root  --maxEvents=25 | tee athenarunOne.log
rc1=${PIPESTATUS[0]}
...
Reco_tf.py --CA --athenaopts="--threads=8" --preExec "${preExecString}" --postExec "${postExecString}" --conditionsTag="${conditionsTagString}" --geometryVersionString="${geometryVersionString}" --inputBSFile /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/RecJobTransformTests/data22_13p6TeV/data22_13p6TeV.00430536.physics_Main.daq.RAW/data22_13p6TeV.00430536.physics_Main.daq.RAW._lb1015._SFO-20._0001.data  --outputAODFile=myAOD.pool.root --outputESDFile=myESD.pool.root  --maxEvents=25 | tee athenarunTwo.log
rc2=${PIPESTATUS[0]}
