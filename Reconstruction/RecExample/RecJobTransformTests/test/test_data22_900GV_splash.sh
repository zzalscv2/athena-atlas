...
Reco_tf.py --CA --multithreaded --inputBSFile /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/RecJobTransformTests/data22_900GeV/data22_900GeV.00423110.physics_Main.daq.RAW/data22_900GeV.00423110.physics_Main.daq.RAW._lb0274._SFO-14._0001.data --maxEvents=300 --conditionsTag="CONDBR2-BLKPA-2022-09" --geometryVersion="ATLAS-R3S-2021-03-01-00" --postExec="cfg.getCondAlgo(\"PixelConfigCondAlg\").doRUN3PIXLinearExtrapolation=True" --outputESDFile myESD.pool.root --outputAODFile myAOD.pool.root --\
