...
def GetCustomAthArgs():
    ...
    parser = ArgumentParser(description='Parser for ClusterDQA configuration')
...
acc.merge(PhysValMonitoringCfg(ConfigFlags, tools=acc.popToolsAndMerge(PhysValClusterCfg(ConfigFlags))))
