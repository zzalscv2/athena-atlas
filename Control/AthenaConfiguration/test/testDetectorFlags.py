...
test_tags = [
    ...
    'ATLAS-P2-RUN4-01-01-00'     # example Run 4
]
...
for tag in test_tags:
    ...
    assert flags.Detector.EnableBCM == (tag != 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnablePixel == (tag != 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnableSCT == (tag != 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnableTRT == (tag != 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnableITkPixel == (tag == 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnableITkStrip == (tag == 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnableHGTD == (tag == 'ATLAS-P2-RUN4-01-01-00')
    assert flags.Detector.EnableCSC == (tag in ['ATLAS-R1-2012-03-02-00', 'ATLAS-R2-2016-01-02-01'])
    assert flags.Detector.EnablesTGC == (tag in ['ATLAS-R3S-2021-03-01-00', 'ATLAS-P2-RUN4-01-01-00'])
    assert flags.Detector.EnableMM == (tag in ['ATLAS-R3S-2021-03-01-00', 'ATLAS-P2-RUN4-01-01-00'])
...
flags = flags_runs['ATLAS-P2-RUN4-01-01-00']
