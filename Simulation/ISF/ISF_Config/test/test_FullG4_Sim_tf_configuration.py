...
class TestFullG4(unittest.TestCase):
    ...
    def test___SimKernel_ListOfSetProperties(self):
        expected_list = ['BeamPipeSimulationSelectors', 'CaloSimulationSelectors', 'CavernSimulationSelectors', 'DetStore', 'DoCPUMonitoring', 'DoMemoryMonitoring', 'TruthPreselectionTool', 'EventFilterTools', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'IDSimulationSelectors', 'InputConverter', 'InputHardScatterCollection', 'InputPileupCollection', 'MSSimulationSelectors', 'MaximumParticleVectorSize', 'MemoryMonitoringTool', 'NeededResources', 'OutputHardScatterTruthCollection', 'OutputPileupTruthCollection', 'ParticleBroker', 'QuasiStablePatcher', 'TruthRecordService', 'UseShadowEvent']
