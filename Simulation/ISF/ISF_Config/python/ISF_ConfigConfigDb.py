...
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTII",           "ISF_Kernel_ATLFASTII")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIMT",         "ISF_Kernel_ATLFASTIIMT")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTII_QS",        "ISF_Kernel_ATLFASTII_QS")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIF",          "ISF_Kernel_ATLFASTIIF")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIF_G4MS",     "ISF_Kernel_ATLFASTIIF_G4MS")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIF_ACTS",     "ISF_Kernel_ATLFASTIIF_ACTS")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIFMT",        "ISF_Kernel_ATLFASTIIFMT")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIF_PileUp",   "ISF_Kernel_ATLFASTIIF_PileUp")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTII_PileUp",   "ISF_Kernel_ATLFASTII_PileUp")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_G4HS_FastPileup",     "ISF_Kernel_G4HS_FastPileup")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIF_IDOnly",   "ISF_Kernel_ATLFASTIIF_IDOnly")
addAlgorithm("ISF_Config.ISF_MainConfigLegacy.getKernel_ATLFASTIIF_IDCalo",   "ISF_Kernel_ATLFASTIIF_IDCalo")
