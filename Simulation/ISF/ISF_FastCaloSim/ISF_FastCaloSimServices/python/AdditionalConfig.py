...
def getPunchThroughTool(name="ISF_PunchThroughTool", **kwargs):
    ...
    kwargs.setdefault("PunchThroughInitiators"  , [ 211, 321, 311, 310, 130, 2212, 2112, 111]        )
    kwargs.setdefault("InitiatorsMinEnergy"     , [ 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192]                                         )
    kwargs.setdefault("InitiatorsEtaRange"      , [ -3.2,   3.2 ]                               )
    kwargs.setdefault("PunchThroughParticles"   , [ 2212,   211,    22,     11,     13,     2112,   321,    310,    130 ]    )
    kwargs.setdefault("DoAntiParticles"         , [ True,   True,   False,  True,   True,   False,  True,   False,  False ]    )
