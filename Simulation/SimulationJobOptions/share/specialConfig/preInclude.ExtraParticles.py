...
## Add the additional ExtraParticles to the accept list
from G4AtlasApps.SimFlags import SimFlags
if hasattr(simFlags, 'ParticleSimAcceptList'):
    SimFlags.ParticleSimAcceptList.set_Value_and_Lock('ISF_ParticleSimAcceptList_ExtraParticles')
