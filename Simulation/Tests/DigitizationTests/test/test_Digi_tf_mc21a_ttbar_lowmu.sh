...
# art-output: mc21a_ttbar_lowmu.CG.RDO.pool.root
# art-output: mc21a_ttbar_lowmu.CA.RDO.pool.root
# art-output: log.*
# art-output: legacy.*
...
Events=25
DigiOutFileNameCG="mc21a_ttbar_lowmu.CG.RDO.pool.root"
DigiOutFileNameCA="mc21a_ttbar_lowmu.CA.RDO.pool.root"
...
Digi_tf.py \
    ...
    --preInclude 'all:Campaigns/MC21LowMu.py' 'HITtoRDO:Campaigns/PileUpMC21LowMu.py' \
    --skipEvents 0 \
    --runNumber 601229 \
...
Digi_tf.py \
    ...
    --preInclude 'HITtoRDO:Campaigns.MC21LowMu' \
    --skipEvents 0 \
    --runNumber 601229
