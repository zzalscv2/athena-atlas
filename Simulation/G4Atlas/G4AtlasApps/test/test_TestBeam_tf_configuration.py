...
class TestTestBeam(unittest.TestCase):
    ...
    def test___G4AtlasAlg_ListOfSetProperties(self):
        expected_list = ['AtRndmGenSvc', 'DetGeoSvc', 'DetStore', 'TruthPreselectionTool', 'EventInfo', 'EvtStore', 'ExtraInputs', 'ExtraOutputs', 'FastSimMasterTool', 'G4Commands', 'GeoIDSvc', 'InputConverter', 'InputTruthCollection', 'MultiThreading', 'NeededResources', 'OutputTruthCollection', 'PhysicsListSvc', 'QuasiStablePatcher', 'RandomGenerator', 'RecordFlux', 'ReleaseGeoModel', 'SenDetMasterTool', 'TruthRecordService', 'UseShadowEvent', 'UserActionSvc', 'UserLimitsSvc', 'Verbosities']
    ...
    def test___GeoModelSvc_DetectorTools_setCorrectly(self):
        expected_property_value = ['TileDetectorTool/TileDetectorTool']
