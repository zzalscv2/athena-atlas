...
L2OverlapRemoverMon :: L2OverlapRemoverMon(const std::string& name, ISvcLocator* pSvcLocator )
  : TrigMuonMonitorAlgorithm(name, pSvcLocator)
{}


StatusCode L2OverlapRemoverMon :: fillVariablesPerChain(const EventContext &, const std::string &chain) const {
...
bool L2OverlapRemoverMon :: isOverlap(const std::string &chain, const ElementLink<xAOD::L2StandAloneMuonContainer>& muEL1, const ElementLink<xAOD::L2StandAloneMuonContainer>& muEL2) const {
...
bool L2OverlapRemoverMon :: isOverlap(const std::string &chain, const ElementLink<xAOD::L2CombinedMuonContainer>& muEL1, const ElementLink<xAOD::L2CombinedMuonContainer>& muEL2) const {
...
float L2OverlapRemoverMon::calcinvMass(double m1, double pt1, double eta1, double phi1,
...
std::tuple<float,float,float> L2OverlapRemoverMon :: L2ORPosForMatchFunc(const xAOD::L2StandAloneMuon *trig){
  return std::forward_as_tuple(trig->pt(), trig->etaMS(), trig->phiMS());
}

std::tuple<float,float,float> L2OverlapRemoverMon :: L2ORPosForMatchFunc(const xAOD::L2CombinedMuon *trig){
