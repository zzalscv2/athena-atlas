...
private:
  ...
  // Define read handles
  Gaudi::Property<SG::ReadHandleKeyArray<xAOD::gFexJetRoIContainer>> m_gFexJetTobKeyList{this,"gFexJetTobKeyList",{"L1_gFexLRJetRoI", "L1_gFexSRJetRoI"},"Array of gFEX jet ReadHandleKeys to fill histograms for"};
  Gaudi::Property<SG::ReadHandleKeyArray<xAOD::gFexJetRoIContainer>> m_gFexRhoTobKeyList{this,"gFexRhoTobKeyList",{"L1_gFexRhoRoI"},"Array of gFEX rho ReadHandleKeys to fill histograms for"};
  Gaudi::Property<SG::ReadHandleKeyArray<xAOD::gFexGlobalRoIContainer>> m_gFexGlobalTobKeyList{this,"gFexGlobalTobKeyList", {"L1_gScalarEJwoj","L1_gMETComponentsJwoj","L1_gMHTComponentsJwoj","L1_gMSTComponentsJwoj","L1_gMETComponentsNoiseCut","L1_gMETComponentsRms","L1_gScalarENoiseCut","L1_gScalarERms"},"Array of gFEX global TOBs ReadHandleKeys to fill histograms for"};
