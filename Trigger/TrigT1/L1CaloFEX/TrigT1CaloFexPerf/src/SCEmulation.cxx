...
namespace LVL1
{
  ...
  StatusCode SCEmulation::execute(const EventContext &ctx) const
  {
  ...
  std::size_t SCEmulation::getEtaIndex(CaloSampling::CaloSample sample, float eta) const
  {
    return getIndex(m_etaBins.at(sample), eta);
  }

  std::size_t SCEmulation::getEtIndex(CaloSampling::CaloSample sample, float et) const
  {
