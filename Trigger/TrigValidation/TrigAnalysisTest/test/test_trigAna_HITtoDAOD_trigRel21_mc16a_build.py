...
hit2rdo.args =  '--inputRDO_BKGFile=' + Input.get_input('pileup_RDO_MC20a').paths[0]
hit2rdo.args += ' --outputRDOFile=RDO.pool.root'
hit2rdo.args += ' --preInclude "all:Campaigns.MC20a"'
...
# RDO -> RDO_TRIG step in 21.0-mc16a
...
rdo2rdotrig.args += ' --preInclude "all:Campaigns/MC20a.py"'
...
rdotrig2aod.args += ' --preInclude "all:Campaigns.MC20a"'
