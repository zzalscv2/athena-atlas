...
Analysis_Efficiency::Analysis_Efficiency(const std::string& name, double pTCut, double etaCut, double d0Cut, double z0Cut) :
  ...
  h_integralD = new TH1D(std::string(m_name+"-denominator-integral").c_str(), std::string(m_name+" integral efficiency denominator").c_str(), 1, 0.0, 1.0);
  h_integralN = new TH1D(std::string(m_name+"-numerator-integral").c_str(),   std::string(m_name+" integral efficiency numerator").c_str(),   1, 0.0, 1.0);
  h_integral  = new TH1D(std::string(m_name+"-integral").c_str(),             std::string(m_name+" integral efficiency").c_str(),             1, 0.0, 1.0);
  addHistogram(h_integralD);
  addHistogram(h_integralN);
  addHistogram(h_integral);
    
  // Create differential efficiency histograms
  h_etaD = new TH1D(std::string(m_name+"-denominator-eta").c_str(), std::string(m_name+" eta efficiency denominator").c_str(), 100, -2.5, 2.5);
  h_phiD = new TH1D(std::string(m_name+"-denominator-phi").c_str(), std::string(m_name+" phi efficiency denominator").c_str(), 100, -3.142, 3.142);
  h_z0D  = new TH1D(std::string(m_name+"-denominator-z0").c_str(),  std::string(m_name+" z0 efficiency denominator").c_str(),  100, -200, 200);
  h_d0D  = new TH1D(std::string(m_name+"-denominator-d0").c_str(),  std::string(m_name+" d0 efficiency denominator").c_str(),  100, -20, 20);
  h_pTD  = new TH1D(std::string(m_name+"-denominator-pT").c_str(),  std::string(m_name+" pT efficiency denominator").c_str(),  100, -10000, 10000);
  addHistogram(h_etaD);
  addHistogram(h_phiD);
  addHistogram(h_z0D);
  addHistogram(h_d0D);
  ...
  h_etaN = new TH1D(std::string(m_name+"-numerator-eta").c_str(), std::string(m_name+" eta efficiency numerator").c_str(), 100, -2.5, 2.5);
  h_phiN = new TH1D(std::string(m_name+"-numerator-phi").c_str(), std::string(m_name+" phi efficiency numerator").c_str(), 100, -3.142, 3.142);
  h_z0N  = new TH1D(std::string(m_name+"-numerator-z0").c_str(),  std::string(m_name+" z0 efficiency numerator").c_str(),  100, -200, 200);
  h_d0N  = new TH1D(std::string(m_name+"-numerator-d0").c_str(),  std::string(m_name+" d0 efficiency numerator").c_str(),  100, -20, 20);
  h_pTN  = new TH1D(std::string(m_name+"-numerator-pT").c_str(),  std::string(m_name+" pT efficiency numerator").c_str(),  100, -10000, 10000);
  addHistogram(h_etaN);
  addHistogram(h_phiN);
  addHistogram(h_z0N);
  addHistogram(h_d0N);
