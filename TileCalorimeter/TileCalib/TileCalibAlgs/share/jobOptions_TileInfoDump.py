...
#tileCoolMgr.setTag(   "oflStatAdc","RUN2-HLT-UPD1-00")
...
#tileCoolMgr.setTag(   "oflNoiseAdc","RUN2-HLT-UPD1-01")
...
#=== To read /TILE/OFL02/TIME/CHANNELOFFSET/PHY from a local tileSqlite.db file
