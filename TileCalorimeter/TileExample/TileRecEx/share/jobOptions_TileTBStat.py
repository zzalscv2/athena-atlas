...
tbstat_log.info("InputDirectory is " + str(InputDirectory))
tbstat_log.info("RunNumber was " + str(RunNumber))
tbstat_log.info("RunNumber is " + str(FormattedRunNumber))
tbstat_log.info("FullFileName is " + str(FileNameVec))

if len(FileNameVec) < 1:
    tbstat_log.fatal("Input file not found")
    sys.exit(1)
