...
# Author: scott snyder
# Date: Oct, 2018
# Brief: Test TileDigitsContByteStreamCnv.
#
...
refdir = None
if r:
    refdir = os.path.join (r, 'TileDigitDumps')
...
from TileRecUtils.TileRecUtilsConf import TileDigitsDumper
topSequence += TileDigitsDumper ('TileDigitsCntDumper',
                                 TileDigitsContainer = 'TileDigitsCnt',
                                 Prefix = dumpdir + '/')
