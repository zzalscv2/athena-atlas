...
# Author: scott snyder
# Date: Oct, 2018
# Brief: Test TileBeamElemContByteStreamCnv.
#
...
#        however, i've not been able to find one that does.
...
refdir = None
if r:
    refdir = os.path.join (r, 'TileBeamElemDumps')
...
from TileRecUtils.TileRecUtilsConf import TileBeamElemDumper
