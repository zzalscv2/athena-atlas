 ...
 */
/**
 * @file TrkVertexSeedFinderUtils/test/SeedNewtonTrkDistanceFinder_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Jun, 2019
 * @brief Unit test for SeedNewtonTrkDistanceFinder.
 */
...
int main()
{
  std::cout << "TrkVertexSeedFinderUtils/SeedNewtonTrkDistanceFinder_test\n";
  ...
  ToolHandle<Trk::ITrkDistanceFinder> tool ("Trk::SeedNewtonTrkDistanceFinder");
