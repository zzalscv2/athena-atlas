...
std::string
TrackRoad::toString() const
{
  std::ostringstream oss;
  oss << "pos"
      //<< " eta=" << m_globalPos.eta()
      << " phi=" << m_globalPos.phi() << " perp=" << m_globalPos.perp()
      << " z=" << m_globalPos.z()
      << " dir"
      //<< " eta=" << m_globalDir.eta()
      << " phi=" << m_globalDir.phi() << " z=" << m_globalDir.z()
      << " deta=" << m_dDeltaEta << " dphi=" << m_dDeltaPhi
      << " type=" << m_type << " weight=" << m_weight;
  return oss.str();
}

MsgStream&
TrackRoad::dump(MsgStream& stream) const
{
...
std::ostream&
TrackRoad::dump(std::ostream& stream) const
{
