...
#ifndef ACTSTRKSPACEPOINTFORMATIONTOOL_ACTSCORESTRIPSPACEPOINTFORMATIONTOOL_H
#define ACTSTRKSPACEPOINTFORMATIONTOOL_ACTSCORESTRIPSPACEPOINTFORMATIONTOOL_H
