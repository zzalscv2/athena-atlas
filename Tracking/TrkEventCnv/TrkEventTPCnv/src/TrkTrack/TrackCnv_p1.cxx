...
//-----------------------------------------------------------------------------
void TrackCnv_p1::persToTrans( const Trk::Track_p1 *persObj,
  Trk::Track    *transObj,
  MsgStream       &log )
{
...
//-----------------------------------------------------------------------------
void TrackCnv_p1::transToPers( const Trk::Track    *,
  Trk::Track_p1 *,
  MsgStream       & )
{
  throw std::runtime_error("TrackCnv_p1::transToPers is deprecated!");
}
