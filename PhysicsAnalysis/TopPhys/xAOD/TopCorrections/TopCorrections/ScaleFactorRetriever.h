...
///-- Top SF enmu, as CP::SystematicSet won't do the job --///
  enum topSFSyst {
    ...
    MU_SF_ID_CR1_UP, MU_SF_ID_CR1_DOWN,
    MU_SF_ID_CR2_UP, MU_SF_ID_CR2_DOWN,
    MU_SF_ID_CR3_UP, MU_SF_ID_CR3_DOWN,
    MU_SF_ID_HIGHETA_PROBEIP_UP, MU_SF_ID_HIGHETA_PROBEIP_DOWN,
    MU_SF_ID_HIGHETA_PROBEISO_UP, MU_SF_ID_HIGHETA_PROBEISO_DOWN,
    MU_SF_ID_TAGPT_UP, MU_SF_ID_TAGPT_DOWN,
    MU_SF_ID_EXTRAPOLATION_UP, MU_SF_ID_EXTRAPOLATION_DOWN,
    ...
    MU_SF_Isol_EXTRAPOLATION_UP, MU_SF_Isol_EXTRAPOLATION_DOWN,
    ...
    MU_SF_TTVA_EXTRAPOLATION_UP, MU_SF_TTVA_EXTRAPOLATION_DOWN,
