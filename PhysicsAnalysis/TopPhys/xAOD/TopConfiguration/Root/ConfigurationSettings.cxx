...
namespace top {
  ...
  ConfigurationSettings::ConfigurationSettings() : m_configured(false) {
    ...
    registerParameter("TDPPath", "Path to TopDataPreparation file (accessible via PathResolver)",
                      "dev/AnalysisTop/TopDataPreparation/XSection-MC16-13TeV_JESinfo.data");
    ...
    registerParameter("ElectronIsolation",
                      "Isolation to use : Gradient, FCLoose, FCTight, FCHighPtCaloOnly, PLVTight, PLVLoose, (EXPERIMENTAL: Tight_VarRad, Loose_VarRad, TightTrackOnly_VarRad, HighPtCaloOnly, Loose, Tight, TightTrackOnly, TightTrackOnly_FixedRad, PLImprovedTight, PLImprovedVeryTight), (DANGEROUS: PflowTight, PflowLoose), None",
                      "FCTight");
    ...
    registerParameter("useJESPrecisionFlavourUncertainties","Enable JES precision flavour uncertainties. If set to 'True' the corresponding calibration files are used." , "False", {"True", "False"});
