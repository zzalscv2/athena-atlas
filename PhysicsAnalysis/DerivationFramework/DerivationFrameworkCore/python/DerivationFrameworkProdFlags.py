...
class WriteDAOD_BPHY22Stream (JobProperty):
     """BPHY22 derivation"""
     statusOn = True
     allowedTypes = ['bool']
     StoredValue = False
     ...
     FileName = ''
     isVirtual = False
     DPDMakerScript = "DerivationFrameworkBPhys/BPHY22.py"
     pass
jobproperties.DerivationFrameworkProdFlags.add_JobProperty(WriteDAOD_BPHY22Stream)
listAODtoDPD.append(WriteDAOD_BPHY22Stream.StreamName)


class WriteDAOD_BPHY23Stream (JobProperty):
     """BPHY23 derivation"""
     statusOn = True
     allowedTypes = ['bool']
     StoredValue = False
     ...
     FileName = ''
     isVirtual = False
     DPDMakerScript = "DerivationFrameworkBPhys/BPHY23.py"
     pass
jobproperties.DerivationFrameworkProdFlags.add_JobProperty(WriteDAOD_BPHY23Stream)
listAODtoDPD.append(WriteDAOD_BPHY23Stream.StreamName)

class WriteDAOD_BPHY24Stream (JobProperty):
     """BPHY24 derivation"""
     statusOn = True
     allowedTypes = ['bool']
     StoredValue = False
     ...
     FileName = ''
     isVirtual = False
     DPDMakerScript = "DerivationFrameworkBPhys/BPHY24.py"
     pass
jobproperties.DerivationFrameworkProdFlags.add_JobProperty(WriteDAOD_BPHY24Stream)
listAODtoDPD.append(WriteDAOD_BPHY24Stream.StreamName)

class WriteDAOD_BPHY25Stream (JobProperty):
     """BPHY25 derivation"""
     statusOn = True
     allowedTypes = ['bool']
     StoredValue = False
     ...
     FileName = ''
     isVirtual = False
     DPDMakerScript = "DerivationFrameworkBPhys/BPHY25.py"
     pass
...
class WriteDAOD_HION11Stream (JobProperty):
     """HION11 derivation"""
     statusOn = True
     allowedTypes = ['bool']
     StoredValue = False
     StreamName = 'StreamDAOD_HION11'
     FileName = ''
     isVirtual = False
     DPDMakerScript = "DerivationFrameworkHI/HION11.py"
     pass
