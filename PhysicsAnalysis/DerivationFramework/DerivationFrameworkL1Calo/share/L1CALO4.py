...
L1CALO4Stream.AddItem("xAOD::JetAuxContainer#AntiKt4EMTopoJetsAux.-PseudoJet")
...
###Phase 1 additions###
L1CALO4Stream.AddItem("xAOD::eFexEMRoI#L1_eEMRoI")
L1CALO4Stream.AddItem("xAOD::eFexEMRoIAuxContainer#L1_eEMRoIAux.")
L1CALO4Stream.AddItem("xAOD::eFexTauRoI#L1_eTauRoI")
L1CALO4Stream.AddItem("xAOD::eFexTauRoIAuxContainer#L1_eTauRoIAux.")
L1CALO4Stream.AddItem("xAOD::eFexTauRoI#L1_cTauRoI")
L1CALO4Stream.AddItem("xAOD::jFexMETRoI#L1_jFexMETRoI")
L1CALO4Stream.AddItem("xAOD::jFexTauRoI#L1_jFexTauRoI")
L1CALO4Stream.AddItem("xAOD::jFexFwdElRoI#L1_jFexFwdElRoI")
L1CALO4Stream.AddItem("xAOD::jFexSRJetRoI#L1_jFexSRJetRoI")
L1CALO4Stream.AddItem("xAOD::jFexLRJetRoI#L1_jFexLRJetRoI")
L1CALO4Stream.AddItem("xAOD::jFexSumETRoI#L1_jFexSumETRoI")
L1CALO4Stream.AddItem("xAOD::gFexJetRoI#L1_gFexRhoRoI")
L1CALO4Stream.AddItem("xAOD::gFexJetRoI#L1_gFexSRJetRoI")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoI#L1_gScalarEJwoj")
L1CALO4Stream.AddItem("xAOD::gFexJetRoI#L1_gFexLRJetRoI")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoI#L1_gMETComponentsJwoj")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoI#L1_gMHTComponentsJwoj")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoI#L1_gMSTComponentsJwoj")
L1CALO4Stream.AddItem("xAOD::eFexTauRoIAuxContainer#L1_cTauRoIAux.")
L1CALO4Stream.AddItem("xAOD::jFexFwdElRoIAuxContainer#L1_jFexFwdElRoIAux.")
L1CALO4Stream.AddItem("xAOD::jFexSumETRoIAuxContainer#L1_jFexSumETRoIAux.")
L1CALO4Stream.AddItem("xAOD::jFexMETRoIAuxContainer#L1_jFexMETRoIAux.")
L1CALO4Stream.AddItem("xAOD::jFexTauRoIAuxContainer#L1_jFexTauRoIAux.")
L1CALO4Stream.AddItem("xAOD::jFexLRJetRoIAuxContainer#L1_jFexLRJetRoIAux.")
L1CALO4Stream.AddItem("xAOD::jFexSRJetRoIAuxContainer#L1_jFexSRJetRoIAux.")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoIAuxContainer#L1_gMHTComponentsJwojAux.")
L1CALO4Stream.AddItem("xAOD::gFexJetRoIAuxContainer#L1_gFexRhoRoIAux.")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoIAuxContainer#L1_gScalarEJwojAux.")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoIAuxContainer#L1_gMETComponentsJwojAux.")
L1CALO4Stream.AddItem("xAOD::gFexGlobalRoIAuxContainer#L1_gMSTComponentsJwojAux.")
L1CALO4Stream.AddItem("xAOD::gFexJetRoIAuxContainer#L1_gFexLRJetRoIAux.")
L1CALO4Stream.AddItem("xAOD::gFexJetRoIAuxContainer#L1_gFexSRJetRoIAux.")
