...
def EGAM8Cfg(ConfigFlags):
    ...
    EGAM8TriggerListsHelper = TriggerListsHelper()
    ...
    for toolStr in acc.getEventAlgo('EGAM8Kernel').AugmentationTools:
        toolStr  = f'{toolStr}'
    ...
    if GainDecoratorTool : 
        EGAM8SlimmingHelper.ExtraVariables.extend( 
    ...
    if ConfigFlags.Trigger.EDMVersion == 2:
        ...
        AddRun2TriggerMatchingToSlimmingHelper(
            ...
            TriggerList = EGAM8TriggerListsHelper.Run2TriggerNamesTau)
        AddRun2TriggerMatchingToSlimmingHelper(
            SlimmingHelper = EGAM8SlimmingHelper, 
            OutputContainerPrefix = 'TrigMatch_',
    ...
    if ConfigFlags.Trigger.EDMVersion == 3:
        ...
        AddRun2TriggerMatchingToSlimmingHelper(
            SlimmingHelper = EGAM8SlimmingHelper, 
            OutputContainerPrefix = 'TrigMatch_', 
            TriggerList = EGAM8TriggerListsHelper.Run3TriggerNamesTau)
        AddRun2TriggerMatchingToSlimmingHelper(
            SlimmingHelper = EGAM8SlimmingHelper, 
            OutputContainerPrefix = 'TrigMatch_',
