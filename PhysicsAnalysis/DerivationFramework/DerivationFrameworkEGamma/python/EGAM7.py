...
def EGAM7Cfg(ConfigFlags):
    ...
    for toolStr in acc.getEventAlgo('EGAM7Kernel').AugmentationTools:
        toolStr  = f'{toolStr}'
    ...
    if GainDecoratorTool : 
        EGAM7SlimmingHelper.ExtraVariables.extend(
    ...
    if ConfigFlags.Trigger.EDMVersion == 2:
        ...
        AddRun2TriggerMatchingToSlimmingHelper(
            ...
            TriggerList = EGAM7TriggerListsHelper.Run2TriggerNamesTau)
        AddRun2TriggerMatchingToSlimmingHelper(
            SlimmingHelper = EGAM7SlimmingHelper, 
            OutputContainerPrefix = 'TrigMatch_',
