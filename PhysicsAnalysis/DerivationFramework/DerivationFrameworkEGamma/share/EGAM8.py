...
EGAM8Stream.AddItem("CaloCellContainer#AllCalo")
EGAM8Stream.AddItem("CaloClusterCellLinkContainer#egammaClusters_links")
EGAM8Stream.AddItem("CaloClusterCellLinkContainer#ForwardElectronClusters_links")
