...
checkFile.py DAOD_JETM11.art.pool.root > checkFile_JETM11.txt

echo "art-result: $?  checkfile"

checkxAOD.py DAOD_JETM11.art.pool.root > checkxAOD_JETM11.txt

echo "art-result: $?  checkxAOD"

checkIndexRefs.py DAOD_JETM11.art.pool.root > checkIndexRefs_JETM11.txt 2>&1
