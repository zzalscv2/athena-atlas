...
formatList = ['PHYSVAL','PHYS',
              ...
              'BPHY1', 'BPHY2', 'BPHY3', 'BPHY4', 'BPHY5', 'BPHY6', 'BPHY7', 'BPHY8', 'BPHY9', 'BPHY10', 'BPHY11', 'BPHY12', 'BPHY13', 'BPHY14','BPHY15','BPHY16', 'BPHY17', 'BPHY18','BPHY19','BPHY20','BPHY21','BPHY22','BPHY23', 'BPHY24', 'BPHY25',
...
mcFileBPHY25 = "/cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/DerivationFrameworkART/AOD.27332925._000069.pool.root.1"
...
if (makeDataDAODs or makeMCDAODs):
   for formatName in formatList:
      if (makeDataDAODs): 
         ...
         elif formatName in ['BPHY13', 'BPHY18','BPHY21','BPHY22','BPHY23','BPHY24','BPHY25']:
            generateText(formatName,dataLabel,dataFile,False,False,"-1")
            generateText(formatName,blsStreamLabel,dataFileBLS,False,False,"1000") 
      ...
      if (makeMCDAODs):
         ...
         elif formatName=="BPHY25":
            generateText(formatName,mcLabel,mcFileBPHY25,False,True,"-1")
