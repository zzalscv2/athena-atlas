...
# Data or simulation?
BPHY12cf.isSimulation = globalflags.DataSource()=='geant4'
...
BPHY12_SelectAndWrite_BdKstarKpiMuMu  = DerivationFramework__Reco_Vertex( name                   = "BPHY12_SelectAndWrite_BdKstarKpiMuMu",
