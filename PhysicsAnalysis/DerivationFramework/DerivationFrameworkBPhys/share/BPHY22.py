...
BPHY22MuPiSelectAndWrite = DerivationFramework__Reco_Vertex(
...
BPHY22DiTrkSelectAndWrite = DerivationFramework__Reco_Vertex(
...
BPHY22Dh3SelectAndWrite = DerivationFramework__Reco_Vertex(
