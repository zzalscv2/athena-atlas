...
from DerivationFrameworkEGamma.EGammaCommon import DerivationFramework__EGSelectionToolWrapper
...
BPHY24cf.isSimulation = DerivationFrameworkHasTruth
...
BPHY24_Finder_DiMuon = Analysis__JpsiFinder( name                        = "BPHY24_Finder_DiMuon",
                                             ...
                                             ConversionFinderHelperTool  = BPHY24_VertexTools.InDetConversionHelper,
...
augsList += [ElectronPassLHvloosenod0]
...
if BPHY24cf.thinData:
  ...
  BPHY24_Thin_VtxTracks = DerivationFramework__Thin_vtxTrk( name                       = "BPHY24_Thin_VtxTracks",
                                                            ThinningService            = "BPHY24ThinningSvc",
...
BPHY24ThinningSvc = createThinningSvc( svcName    = "BPHY24ThinningSvc",
                                       outStreams = [ evtStream ] )
svcMgr += BPHY24ThinningSvc
