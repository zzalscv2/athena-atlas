...
def makeSequenceBlocks (dataType, algSeq) :
    ...
    makeMuonWorkingPointConfig (configSeq, 'AnalysisMuons', workingPoint='Medium.NonIso', postfix='medium')
    makeMuonWorkingPointConfig (configSeq, 'AnalysisMuons', workingPoint='Tight.NonIso', postfix='tight')
