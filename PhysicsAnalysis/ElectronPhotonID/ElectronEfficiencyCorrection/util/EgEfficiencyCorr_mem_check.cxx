...
--suppressions=$ROOTSYS/etc/valgrind-root.supp  --error-limit=no \
   --track-origins=yes --smc-check=all --trace-children=yes  --track-fds=yes
--num-callers=30  \
   $ROOTCOREBIN/bin/x86_64-slc6-gcc49-opt/EgEfficiencyCorr_mem_check>valgrind.log
2>&1 &
