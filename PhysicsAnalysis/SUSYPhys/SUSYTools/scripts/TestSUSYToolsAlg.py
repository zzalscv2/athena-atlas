...
parser.add_option('-t', '--type', dest = 'type', default = 'mc16e', help = 'Job type. (mc16a, mc16d, mc16e, mc20a, mc20d, mc20e, mc21a, data18, data22)', choices = ['mc16a', 'mc16d', 'mc16e', 'mc20a', 'mc20d', 'mc20e','mc21a', 'data18', 'data22'])
...
parser.add_option('-p', '--ptag', dest = 'ptag', default = 'p5057', help = 'ptag' )
...
ptageqdata = {'p4016':'p4017','p4095':'p4096','p4237':'p4238','p4441':'p4441','p4631':'p4441','p4853':'p4853','p5057':'p5057','p5226':'p5226'}
