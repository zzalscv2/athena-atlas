...
echo "Running SUSYTools test: \'TestSUSYToolsAlg.py -f PHYS -t mc21a -m 2000 -p p5440 --inputFile DAOD_PHYS.mc21_13p6TeV.601229.FS_mc21a_p5440.PHYS.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/ --dosyst'"
TestSUSYToolsAlg.py -f PHYS -t mc21a -m 2000 -p p5440 --inputFile DAOD_PHYS.mc21_13p6TeV.601229.FS_mc21a_p5440.PHYS.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/ --dosyst 
