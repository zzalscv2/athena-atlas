...
echo "Running SUSYTools test: \'TestSUSYToolsAlg.py -f PHYS -t data18 -p p5226 --inputFile DAOD_PHYS.data18_13TeV.356250.data18_p5226.PHYS.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/'"
TestSUSYToolsAlg.py -f PHYS -t data18 -p p5226 --inputFile DAOD_PHYS.data18_13TeV.356250.data18_p5226.PHYS.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/
