...
echo "Running SUSYTools test: \'TestSUSYToolsAlg.py -f PHYS -t data22 -p p5267 --inputFile DAOD_PHYS.data22_13p6TeV.430542.data22_p5267.PHYS.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/'"
TestSUSYToolsAlg.py -f PHYS -t data22 -p p5267 --inputFile DAOD_PHYS.data22_13p6TeV.430542.data22_p5267.PHYS.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/
