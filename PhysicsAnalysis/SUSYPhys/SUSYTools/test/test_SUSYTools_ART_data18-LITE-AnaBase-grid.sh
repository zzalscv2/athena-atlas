...
echo "Running SUSYTools test: \'TestSUSYToolsAlg.py -f PHYSLITE -t data18 -p p5631 --inputFile data18_13TeV.00356250_p5631.PHYSLITE.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/'"
TestSUSYToolsAlg.py -f PHYSLITE -t data18 -p p5631 --inputFile data18_13TeV.00356250_p5631.PHYSLITE.pool.root --inputDir /cvmfs/atlas-nightlies.cern.ch/repo/data/data-art/SUSYTools/
