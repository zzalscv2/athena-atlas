...
echo "Running SUSYTools test: 'share/minimalExampleJobOptions.py -c \'MCCampaign=\"mc20e\";IsPHYSLITE=True\;' '"
athena SUSYTools/minimalExampleJobOptions.py --evtMax=2000 -c 'MCCampaign="mc20e";IsPHYSLITE=True'
