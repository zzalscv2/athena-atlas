...
echo "Running SUSYTools test: 'share/minimalExampleJobOptions.py -c \'MCCampaign=\"data18\";IsPHYSLITE=True\;' '"
athena SUSYTools/minimalExampleJobOptions.py -c 'MCCampaign="data18";IsPHYSLITE=True'
