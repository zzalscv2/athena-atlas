...
echo "Running SUSYTools test: 'share/athena SUSYTools/jobOptions.py - --testCampaign data22 --testFormat PHYSLITE'"
athena SUSYTools/jobOptions.py - --testCampaign data22 --testFormat PHYSLITE
