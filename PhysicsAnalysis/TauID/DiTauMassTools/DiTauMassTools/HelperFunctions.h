...
{
  enum e { MMC2015=0, MMC2015HIGHMASS, UPGRADE, LFVMMC2012, MMC2019, MAXMMCCALIBRATIONSET };
  const std::string name[MAXMMCCALIBRATIONSET]={ "MMC2015", "MMC2015HIGHMASS", "UPGRADE", "LFVMMC2012", "MMC2019"};
}
