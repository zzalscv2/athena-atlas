  ...
  AthAlgorithm(name,pSvcLocator)
{
  ...
  declareProperty("overrideDefaults", m_overrideDefaults, "true if new results are to be used as default");
...
StatusCode Analysis::CalibrationDataUpdater::initialize()
{
  ...
  TFile* fIn = 0;
  bool newInput = (m_inputRootFile.empty());
  if (newInput) {
...
void Analysis::CalibrationDataUpdater::setDefaultResults(const string& Name, TFile* fOut) const
{
  fOut->cd("/");
...
bool Analysis::CalibrationDataUpdater::isValidName(const string& Name) const
{
...
void Analysis::CalibrationDataUpdater::writeOutput(TObject* in, const string& Name, TFile* fOut) const
{
