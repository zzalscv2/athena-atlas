...
AlignmentTriggerMuonStream.AddItem(["xAOD::TrigCompositeContainer#HLTNav_Summary_OnlineSlimmed"])
AlignmentTriggerMuonStream.AddItem(["xAOD::TrigCompositeAuxContainer#HLTNav_Summary_OnlineSlimmedAux."])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonContainer#HLT_MuonsCB_RoI"])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonAuxContainer#HLT_MuonsCB_RoIAux."])
...
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIContainer#LVL1MuonRoIsBCp1"])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIContainer#LVL1MuonRoIsBCp2"])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIContainer#LVL1MuonRoIsBCm1"])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIContainer#LVL1MuonRoIsBCm2"])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIAuxContainer#LVL1MuonRoIsBCp1Aux."])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIAuxContainer#LVL1MuonRoIsBCp2Aux."])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIAuxContainer#LVL1MuonRoIsBCm1Aux."])
AlignmentTriggerMuonStream.AddItem(["xAOD::MuonRoIAuxContainer#LVL1MuonRoIsBCm2Aux."])
