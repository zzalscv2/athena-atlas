...
include.block("PrimaryDPDMaker/PerfDPD_EOverP.py")


## for messaging
from AthenaCommon.Logging import logging
eoverpDPDStream_msg = logging.getLogger( 'PrimaryDPD_PerfEOverPStream' )
...
#    eoverpDPDStream_msg.info('Values of all PrimaryDPDFlags_EOverPStream flags:')    
#    print primEOverPDPD
#    pass
...
desdEOverPSequence = CfgMgr.AthSequencer( 'DESDM_EOVERP_Sequence',
                                                  StopOverride = True )
...
DESDM_EOVERP_SkimmingTool = DerivationFramework__xAODStringSkimmingTool(name = "DESDM_EOVERP_SkimmingTool", expression = desd_trig)
ToolSvc += DESDM_EOVERP_SkimmingTool
from DerivationFrameworkCore.DerivationFrameworkCoreConf import DerivationFramework__DerivationKernel
desdEOverPSequence += CfgMgr.DerivationFramework__DerivationKernel("DESDM_EOVERPKernel",
                                                               SkimmingTools = [DESDM_EOVERP_SkimmingTool]
                                                               )

topSequence += desdEOverPSequence

##====================================================================
## Define the Single Electron DPD output stream
##====================================================================
streamName = primDPD.WriteEOverPStream.StreamName
fileName   = buildFileName( primDPD.WriteEOverPStream )
if primDPD.WriteEOverPStream.isVirtual or primDPD.isVirtual() :
    EOverPStream=MSMgr.NewVirtualStream( streamName, fileName )
    pass
else:
    EOverPStream=MSMgr.NewPoolStream( streamName, fileName )
    pass

EOverPStream.AddRequireAlgs(["DESDM_EOVERPKernel"]) 
