...
outList = CfgItemList( 'IDALIGN',
    ...
    'xAOD::TrackParticleAuxContainer#ExtrapolatedStauTrackParticlesAux.-clusterAssociation',
    ...
    'xAOD::TrackParticleAuxContainer#InDetDisappearingTrackParticlesAux.-caloExtension.-cellAssociation.-clusterAssociation',
