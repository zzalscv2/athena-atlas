...
#    __metaclass__ = Singleton
    ...
    def __init__(self):
       ...
       #self.add_default("semileptonic", 0, hidden=True, description="WWj decay mode: W->lnu W->jj [1:enabled]") ## parameter with same same already exists, with different default
        ...
        self.add_default("bornsmartsig", 0, description="LQ-s-chan: born level smart signal. [0:disabled]")
        ...
        self.add_default("BWgen", 1, description="[1: LQ s chan]")
        ...
        self.add_default("charge", 1, description="LQ-s-chan charge of the LQ times 3. Expect 1,2,4 or 5. [1: default]")
        ...
        self.add_default("contr", "\'full\'",description="Contributions in gg4l:'full', 'only_h', 'no_h' or 'interf_h'")
        ...
        self.add_default("massiveloops", 0, description="gg4l: use mass in loops")
        ...
        self.add_default("mLQ", 2000, description="[2000: LQ-s-chan - mass of the lepto-quark]")
        self.add_default("mLQcuthi", 0, description="[0: LQ-s-chan m lepto-quark high cut]")
        self.add_default("mLQcutlo", 0, description="[0: LQ-s-chan m lepto-quark low cut]")
        ...
        self.add_default("ol_nf", 6, description="gg4l: OpenLoops number of massless flavours")
        self.add_default("ol_notri", 0, description="gg4l: OpenLoops notri")
        self.add_default("ol_preset", 3,description="gg4l: OpenLoops preset")
        self.add_default("ol_stability_kill", 0.01,description="gg4l: stability kill")
        self.add_default("ol_verbose", 1,description="gg4l: OpenLoops verbose")
        ...
        self.add_default("proc","\'WW\'" ,description="Process in gg4l ZZ or WW")
        self.add_default("psgen", -1, description="[-1:use Powheg default]")
        self.add_default("ptborncut", -1, description="[-1:use Powheg default]")
        self.add_default("ptcutlep", 0, description="[0: LQ-s-chan pT cut on leptons]")
        self.add_default("ptcutjet", 0, description="[0: LQ-s-chan pT cut on jets]")
        ...
        self.add_default("ptllmin", 0.1, description="gg4l this is hard-coded for virtual corrections with massive loops") 
        ...
        self.add_default("ptVVcut_CT", 0.1, description="gg4l: amplitude option")
        self.add_default("ptVVcut", 0.1, description="gg4l: amplitude option")
        ...
        self.add_default("recombination", 1, description=":LQ-s-chan: recombenation")
        ...
        self.add_default("select_real", 0, description="gg4l: do gg qg qq channels") 
        ...
        self.add_default("useoldphsp", 0, description="gg4l: use the old phase space parametrization from ggZZ")
        ...
        self.add_default("widthLQ", 0., description="LQ-s-chan [0: no width]")
        ...
        self.add_default("Wolfenstein_lambda", powheg_atlas_common.WS_parameters.lam, name="Wolfenstein_lambda", description="Wolfenstein lambda parameter")
        self.add_default("Wolfenstein_A", powheg_atlas_common.WS_parameters.A, name="Wolfenstein_A", description="Wolfenstein A parameter")
        self.add_default("Wolfenstein_rho", powheg_atlas_common.WS_parameters.rho, name="Wolfenstein_rho", description="Wolfenstein rho parameter")
        self.add_default("Wolfenstein_eta", powheg_atlas_common.WS_parameters.eta, name="Wolfenstein_eta", description="Wolfenstein eta parameter")
        ...
        self.add_default("y_1m", 0, description="LQ-s-chan: coupling of the lepto-quark.")
        self.add_default("y_2m", 0, description="LQ-s-chan: coupling of the lepto-quark.")
        self.add_default("y_3m", 0, description="LQ-s-chan: coupling of the lepto-quark.")
        self.add_default("y_1t", 0, description="LQ-s-chan: coupling of the lepto-quark.")
        self.add_default("y_2t", 0, description="LQ-s-chan: coupling of the lepto-quark.")
        self.add_default("y_3t", 0, description="LQ-s-chan: coupling of the lepto-quark.")
