...
class Wt_DS(PowhegV2):
    ...
    def __init__(self, base_directory, **kwargs):
        ...
        """
        super(Wt_DS, self).__init__(base_directory, "ST_wtch_DS", **kwargs)
    ...
    def validate_decays(self):
        ...
        list(self.parameters_by_keyword("ttype"))[0].value = [+1, -1][self.decay_mode_top.startswith("t~")]
        list(self.parameters_by_keyword("topdecaymode"))[0].value = __decay_mode_lookup[__top_decay]
        list(self.parameters_by_keyword("wdecaymode"))[0].value = __decay_mode_lookup[__W_decay]
