...
void MdtRawDataValAlg::TubeID_to_ID_L_ML(int& tubeID, std::string_view hardware_name, int& derived_tube, int& derived_layer,
                                         int& derived_ML, int totalTubes) {
    derived_tube = 1;
    derived_layer = 1;
    derived_ML = 1;
...
StatusCode MdtRawDataValAlg::bookMDTHisto_overview_2D(TH2*& h, TString h_title, TString xtit, TString ytit, int nbin1, float xi1, float xf1,
                                                      int nbin2, float xi2, float xf2, MonGroup& mgrp) {
...
StatusCode MdtRawDataValAlg::bookMDTHisto_chambers_2D(TH2F_LW*& h, TString h_title, TString xtit, TString ytit, int nbin1, float xi1,
                                                      float xf1, int nbin2, float xi2, float xf2, MonGroup& mgrp) {
...
std::string MdtRawDataValAlg::getChamberName(const Muon::MdtPrepData* hit) { return getChamberName(hit->identify()); }
