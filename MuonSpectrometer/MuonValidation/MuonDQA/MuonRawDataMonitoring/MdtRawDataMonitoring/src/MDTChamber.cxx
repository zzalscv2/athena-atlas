...
MDTChamber::MDTChamber(std::string_view name) :
    ...
    if (name.size() >= 7) {
        ...
        // set m_barrel_region
        if (Barrel == 'B' && (Side == 'A' || Side == 'B'))
            m_barrel_region = 0;
        else if (Barrel == 'B' && Side == 'C')
            m_barrel_region = 1;
        else if (Barrel == 'E' && (Side == 'A' || Side == 'B'))
            m_barrel_region = 2;
        else if (Barrel == 'E' && Side == 'C')
            m_barrel_region = 3;
        else {
        ...
        if ((Barrel == 'B' && name.substr(0, 3) != "BEE" && name.substr(0, 3) != "BIS") ||
            (name.substr(0, 3) == "BIS" && m_station_eta < 6)) {
...
void MDTChamber::SetMDTHitsPerML_byLayer_Bins(TH2F* h_mdthitspermultilayerLumi, TH2F* h_mdthitsperML_byLayer) {
    ...
    if (m_hardware_name == "BME1A14" || m_hardware_name == "BME1A13") { ecap_layer = "BMA4"; }
    if (m_hardware_name == "BME1C14" || m_hardware_name == "BME1C13") { ecap_layer = "BMC4"; }
    ...
    if ((statphi_ml1_s.substr(0, 2) == "11" || statphi_ml1_s.substr(0, 2) == "15") && m_hardware_name.at(0) == 'E' &&
        (m_layer_region == 0 || m_layer_region == 3)) {
