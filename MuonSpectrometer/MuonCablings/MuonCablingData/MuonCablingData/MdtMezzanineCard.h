...
///     MdtMezzanineCard - 
///     Helper struct to represent the structure of a mezzanine card in a consistent way
///     Each mezzanine card reads out in total 24 tubes of a chamber covering
///     all tube layers of a chamber. Given that a chamber has either 3 or 4 layers, 
///     8 or 6 tubes per layer are read out by the cards. The assignment of the tdc channels
///     to the tubes does not follow a distinct pattern:
///
///                Layer 2:   (01) (03) (05) (07) (06) (04) (02) (00)   
///                Layer 1: (09) (11) (13) (15) (14) (12) (10) (08)
///                Layer 0:   (17) (19) (21) (23) (22) (20) (18) (16)
///
///     To preserve a continuous memory layout and to ease the translation of online -> offline
///     numbering scheme, the tubes are numbered sequentially 
///                Layer 2:    (16) (17) (18) (19) (20) (21) (22) (23)    
///                Layer 1: (08) (09) (10) (11) (12) (13) (14) (15) 
///                Layer 0:    (00) (01) (02) (03) (04) (05) (06) (07) 
///     The mapping between the two schemes is represented by a 24 long array, where the index
///     is the channel number, tdc in the case of online -> offline, and tube number in the case of online
///     to online.
class MdtMezzanineCard {
    public:
        ...
        /// @param mezz_id: Global identifier number to map the card in the online <-> offline conversion 
