...
struct NrpcCablingOffData {
    ...
    NrpcCablingOffData(const NrpcCablingOffData& other) : NrpcCablingOffData() { m_cache.hash = other.m_cache.hash; }
    ...
    /// Equality operator
    bool operator==(const NrpcCablingOffData& other) const { return m_cache.hash == other.m_cache.hash; }
    bool operator!=(const NrpcCablingOffData& other) const { return m_cache.hash != other.m_cache.hash; }
    bool operator<(const NrpcCablingOffData& other) const { return m_cache.hash < other.m_cache.hash; }
...
struct NrpcCablingOnData {
    ...
    NrpcCablingOnData(const NrpcCablingOnData& other) : 
    NrpcCablingOnData() { 
    ...
    bool operator==(const NrpcCablingOnData& other) const { return m_cache.hash == other.m_cache.hash; }
    bool operator!=(const NrpcCablingOnData& other) const { return m_cache.hash != other.m_cache.hash; }
    bool operator<(const NrpcCablingOnData& other) const { return m_cache.hash < other.m_cache.hash; }
    bool operator!() const { return !m_cache.hash; }
...
struct NrpcCablingData : public NrpcCablingOffData, NrpcCablingOnData {
    ...
    bool operator!=(const NrpcCablingData& other) const { return !((*this) == other); }
    bool operator<(const NrpcCablingData& other) const {
        if (this->NrpcCablingOffData::operator!=(other)) return this->NrpcCablingOffData::operator<(other);
        if (this->NrpcCablingOnData::operator!=(other)) return this->NrpcCablingOnData::operator<(other);
