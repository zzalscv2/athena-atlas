    ...
    */
    ...
    private:
        ...
        ToolHandle<Muon::IMuonSegmentMaker> m_segMaker{
            this, "SegmentMaker", "Muon::DCMathSegmentMaker/DCMathSegmentMaker"};  //!< actual segment maker with hole search
        ToolHandle<Muon::IMuonSegmentMaker> m_segMakerNoHoles{
            this, "SegmentMakerNoHoles", "Muon::DCMathSegmentMaker/DCMathSegmentMaker"};  //!< actual segment maker no hole search
