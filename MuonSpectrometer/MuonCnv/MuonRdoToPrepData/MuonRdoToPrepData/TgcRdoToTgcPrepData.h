...
private:
    ...
    ToolHandle<Muon::IMuonRdoToPrepDataTool> m_tool{this, "DecodingTool", "Muon::TgcRdoToPrepDataToolMT/TgcPrepDataProviderTool",
                                                    "tgc rdo to prep data conversion tool"};
