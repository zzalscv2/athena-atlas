...
*/
/**
 * @file MuonSimEventTPCnv/test/RPCSimHitCollectionCnv_p1_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Mar, 2016
 * @brief Tests for RPCSimHitCollectionCnv_p1.
 */
...
void testit (const RPCSimHitCollection& trans1)
{
  ...
  RPCSimHitCollectionCnv_p1 cnv;
  Muon::RPCSimHitCollection_p1 pers;
