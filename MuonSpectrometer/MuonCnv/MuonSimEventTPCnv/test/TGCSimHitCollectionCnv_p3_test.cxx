...
*/
/**
 * @file MuonSimEventTPCnv/test/TGCSimHitCollectionCnv_p3_test.cxx
 * @author scott snyder <snyder@bnl.gov>
 * @date Mar, 2016
 * @brief Tests for TGCSimHitCollectionCnv_p3.
 */
...
void testit (const TGCSimHitCollection& trans1)
{
  ...
  TGCSimHitCollectionCnv_p3 cnv;
  Muon::TGCSimHitCollection_p3 pers;
