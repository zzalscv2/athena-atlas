...
namespace Muon {
  ...
  static const InterfaceID IID_IMMTP_L1A_ROD_Decoder("Muon::IMMTP_L1A_ROD_Decoder", 1, 0);
  ...
  public:
    static const InterfaceID& interfaceID() { return IID_IMMTP_L1A_ROD_Decoder; }
