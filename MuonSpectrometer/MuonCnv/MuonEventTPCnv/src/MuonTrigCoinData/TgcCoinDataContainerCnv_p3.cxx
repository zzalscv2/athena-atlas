...
void Muon::TgcCoinDataContainerCnv_p3::transToPers(const Muon::TgcCoinDataContainer* transCont,  Muon::MuonCoinDataContainer_p1* persCont, MsgStream &log) 
{
...
void  Muon::TgcCoinDataContainerCnv_p3::persToTrans(const Muon::MuonCoinDataContainer_p1* persCont, Muon::TgcCoinDataContainer* transCont, MsgStream &log) 
{
...
//================================================================
Muon::TgcCoinDataContainer* Muon::TgcCoinDataContainerCnv_p3::createTransient(const Muon::MuonCoinDataContainer_p1* persObj, MsgStream& log) 
{
    if(!m_isInitialized) {
