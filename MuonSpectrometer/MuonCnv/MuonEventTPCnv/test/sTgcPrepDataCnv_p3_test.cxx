...
*/
/**
 * @file MuonEventTPCnv/test/sTgcPrepDataCnv_p3_test.cxx
 * @brief Regression tests, copied from the _p2 version and added test of quality and author.
 */
...
void testit (const Muon::sTgcPrepData& trans1)
{
  ...
  sTgcPrepDataCnv_p3 cnv;
  Muon::sTgcPrepData_p3 pers;
