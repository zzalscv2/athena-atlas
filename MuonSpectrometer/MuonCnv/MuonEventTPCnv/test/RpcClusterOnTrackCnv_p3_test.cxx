...
*/
/**
 * @file MuonEventTPCnv/test/RpcClusterOnTrackCnv_p3_test.cxx
...
void compare (const Muon::RpcClusterOnTrack& p1,
              const Muon::RpcClusterOnTrack& p2)
{
...
void testit (const Muon::RpcClusterOnTrack& trans1)
{
  MsgStream log (nullptr, "test");
  RpcClusterOnTrackCnv_p3 cnv;
  ...
  Muon::RpcClusterOnTrack_p3 pers;
  cnv.transToPers (&trans1, &pers, log);
  Muon::RpcClusterOnTrack trans2;
...
void test1 ATLAS_NOT_THREAD_SAFE (const MuonGM::MuonDetectorManager& muo_dd)
{
  ...
  Muon::RpcClusterOnTrack trans1 (rio,
                                  locpos,
                                  cov,
                                  clusId,
