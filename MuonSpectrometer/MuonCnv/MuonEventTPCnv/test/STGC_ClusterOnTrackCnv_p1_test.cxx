...
*/
/**
 * @file MuonEventTPCnv/test/STGC_ClusterOnTrackCnv_p21_test.cxx
...
void compare (const Muon::sTgcClusterOnTrack& p1,
              const Muon::sTgcClusterOnTrack& p2)
{
...
void testit (const Muon::sTgcClusterOnTrack& trans1)
{
  MsgStream log (nullptr, "test");
  STGC_ClusterOnTrackCnv_p1 cnv;
  ...
  Muon::STGC_ClusterOnTrack_p1 pers;
  cnv.transToPers (&trans1, &pers, log);
  Muon::sTgcClusterOnTrack trans2;
...
void test1 ATLAS_NOT_THREAD_SAFE (const MuonGM::MuonDetectorManager& muo_dd)
{
  ...
  ElementLinkToIDC_STGC_Container rio (333, 222);

  // 57 == STS
  Identifier clusId = muo_dd.stgcIdHelper()->channelID (57, 2, 2, 1, 1, 0, 1);
