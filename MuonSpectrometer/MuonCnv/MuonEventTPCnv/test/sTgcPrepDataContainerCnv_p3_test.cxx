...
*/
/**
 * @file MuonEventTPCnv/test/sTgcPrepDataContainerCnv_p3_test.cxx
 * @brief Regression tests, copied from the _p2 version.
 */
...
void testit (const Muon::sTgcPrepDataContainer& trans1)
{
  ...
  Muon::sTgcPrepDataContainerCnv_p3 cnv;
  Muon::sTgcPrepDataContainer_p3 pers;
