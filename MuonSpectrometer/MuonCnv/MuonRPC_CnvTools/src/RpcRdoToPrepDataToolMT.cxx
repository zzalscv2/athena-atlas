...
Muon::RpcRdoToPrepDataToolMT::MyState::MyState(const RpcIdHelper& idHelper, MsgStream& msg) :
...
Muon::RpcRdoToPrepDataToolMT::RpcRdoToPrepDataToolMT(const std::string& type, const std::string& name, const IInterface* parent) :
    ...
    declareProperty("RpcPrdContainerCacheKey", m_prdContainerCacheKey, "Optional external cache for the RPC PRD container");
    declareProperty("RpcCoinDataContainerCacheKey", m_coindataContainerCacheKey, "Optional external cache for the RPC coin data container");
}
...
void Muon::RpcRdoToPrepDataToolMT::printPrepData() const {
    ...
    printPrepDataImpl(*SG::makeHandle(prepDataKey, ctx).get(), *SG::makeHandle(prepCoinKey, ctx).get());
}
