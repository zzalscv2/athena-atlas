...
Muon::RPC_RawDataProviderToolCore::RPC_RawDataProviderToolCore(const std::string& t, const std::string& n, const IInterface* p) :
    AthAlgTool(t, n, p), m_robDataProvider("ROBDataProviderSvc", n) {}
...
StatusCode Muon::RPC_RawDataProviderToolCore::convertIntoContainers(
