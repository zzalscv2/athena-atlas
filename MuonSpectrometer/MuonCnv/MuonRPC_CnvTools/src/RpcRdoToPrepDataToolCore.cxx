    ...
    m_decodeData(true)                    //!< toggle on/off the decoding of RPC RDO into RpcPrepData
{
    ...
    declareProperty("etaphi_coincidenceTime",
                    m_etaphi_coincidenceTime = 20.);  //!< 15 ns should be the max.diff. in prop.time in phi and eta strips
    ...
    declareProperty("TriggerOutputCollection", m_rpcPrepDataContainerKey = std::string("RPC_Measurements"),
...
//___________________________________________________________________________
StatusCode Muon::RpcRdoToPrepDataToolCore::decodeImpl(State& state, getPrepCollection_func& getPrepCollection,
...
void Muon::RpcRdoToPrepDataToolCore::printPrepDataImpl(const Muon::RpcPrepDataContainer& rpcPrepDataContainer,
...
void Muon::RpcRdoToPrepDataToolCore::printCoinDataImpl(const Muon::RpcCoinDataContainer& rpcCoinDataContainer) const {
    ATH_MSG_INFO("********************************************************************************************************");
...
StatusCode Muon::RpcRdoToPrepDataToolCore::processPad(
...
void Muon::RpcRdoToPrepDataToolCore::processTriggerHitHypothesis(RpcCoinMatrix::const_iterator itD, RpcCoinMatrix::const_iterator itD_end,
                                                                 bool highPtCm,
